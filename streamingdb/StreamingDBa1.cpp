...
StatusType streaming_database::user_watch(int userId, int movieId)
{
    ...
    movie.watch();
    this->insertMovieToGenresTreeArray(movieNode->m_value->getGenre(), movie);
