...
public:
    ...
    AvlNode(Key key, Value value): height(0),value(value),key(key),
    parent(nullptr),right_son(nullptr),left_son(nullptr) {}
...
template<class Key, class Value>
AvlNode<Key, Value>* AvlTree<Key, Value>::FindMaxNode() {
